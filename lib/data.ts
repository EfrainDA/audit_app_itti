...
export const mockUsers: User[] = [
  ...
  { id: '4', name: 'Efrain Gonzalez', email: 'efrain.gonzalez@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '7', name: 'Nilce Noguera', email: 'nilce@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '8', name: 'Silvia Musso', email: 'silvia@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '9', name: 'Federico Figueredo', email: 'federico.figueredo@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '10', name: 'Agustin Enciso', email: 'agustin@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '11', name: 'Vanessa Coronel', email: 'vanessa.coronel@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '12', name: 'Fernando Peña', email: 'fernando@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '13', name: 'Ana Fariña', email: 'ana.farina@qualittyx.com', role: 'auditor', status: 'activo' },
  { id: '14', name: 'Wilfrido Benitez', email: 'wilfrido.benitez@qualittyx.com', role: 'auditor', status: 'activo' },

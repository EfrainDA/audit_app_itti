  ...
  return (
    <input
      ...
      className={cn(
        ...
        'focus-visible:border-ring focus-visible:bg-background/92 focus-visible:ring-ring/18 focus-visible:ring-[3px] focus-visible:shadow-[0_8px_24px_oklch(0.32_0.04_252/0.09)]',
